...
Move::Move(){//コンストラクタ
	...
	paras[0] = { 16, 4, 100, 300, 300, 400, 15, 31, 10 };    //ブロック個数毎のパラメーター
	paras[1] = { 64, 8, 50, 350, 350, 800, 63, 127, 10 };
	paras[2] = { 256, 16, 25, 375, 375, 1000, 255, 511, 5 };
	paras[3] = { 1600, 40, 10, 390, 390, 2000, 1599, 3199, 5 };
	paras[4] = { 10000, 100, 4, 396, 396, 9000, 9999, 19999, 4 };
	paras[5] = { 160000, 400, 1, 399, 399, 300000, 159999, 319999, 1 };
